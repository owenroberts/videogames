...
kmi = km.keymap_items.new('view3d.view_selected', 'F', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('view3d.viewnumpad', 'SEVEN', 'PRESS')
kmi_props_setattr(kmi.properties, 'type', 'LEFT')
kmi = km.keymap_items.new('view3d.viewnumpad', 'EIGHT', 'PRESS')
